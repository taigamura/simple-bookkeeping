...
- Name: sheets.spec.ts >> ghost overlay >> calendar day taps register after every dismissal path
- Location: e2e/sheets.spec.ts:176:7
...
Call log:
  ...
  - waiting for getByTestId('entry-sheet')
    14 × locator resolved to <div data-testid="entry-sheet" class="css-g5y9jx r-1d2f490 r-u8s1d r-zchlnj r-ipm5af">…</div>
...
- radio "Entertainment"
- 'button "Note: —"': Note —
- 'button "↻ Repeat: Never"': ↻ Repeat Never
- button "1"
- button "2"
- button "3"
- button "4"
