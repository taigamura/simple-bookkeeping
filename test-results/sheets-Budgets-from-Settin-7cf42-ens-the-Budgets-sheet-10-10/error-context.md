...
- Name: sheets.spec.ts >> Budgets from Settings >> Budgets row opens the Budgets sheet, 10/10
- Location: e2e/sheets.spec.ts:65:7

# Error details

```
Error: settings-sheet should rise into the viewport, not sit collapsed below it — attempt #1
