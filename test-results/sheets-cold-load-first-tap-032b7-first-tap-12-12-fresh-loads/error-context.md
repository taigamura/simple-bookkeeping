...
- Name: sheets.spec.ts >> cold-load first tap >> ⚙ opens the Settings sheet on the first tap, 12/12 fresh loads
- Location: e2e/sheets.spec.ts:55:7

# Error details

```
Error: settings-sheet should rise into the viewport, not sit collapsed below it — cold load #1
