# Verify the current MoneyForward CSV contract

> GitHub issue #109 | Labels: ready-for-agent, P1 | https://github.com/taigamura/simple-bookkeeping/issues/109
...
Produce an evidence-backed, synthetic-fixture contract for current MoneyForward transaction exports before implementing an adapter; do not guess headers or use personal financial data.
