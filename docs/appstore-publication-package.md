...
This document contains the complete App Store publication materials for the bilingual V1 release. The public name **Suito** and localized subtitles are final. Internal identifiers (`com.taigamura.kaji` and the Expo slug) deliberately remain unchanged.
...
The final public name is Suito. Use this checklist to verify consistent branding:

### Documentation and Code
- [x] Update `docs/appstore-publication-package.md` with the final name and subtitles.
- [x] Update `docs/appstore-readiness.md` with the final public name.
- [x] Update `docs/v1-privacy-mode.md` with the final public name.
- [x] Update `README.md` with the final public name.
- [x] Update `app.json` with the final display name; retain the existing slug and bundle identifiers for release continuity.
- [ ] Update `package.json` – update the `name` field if desired (optional, but recommended for clarity).

### App UI and Copy
- [x] Update localized app-name copy in `i18n/strings.ts`.
...
- [ ] In App Store Connect:
  - [ ] App Name: `Suito`
  - [ ] Subtitle: "Bookkeeping, never in the red"
  - [ ] Description: Verify it uses the final public name
  - [ ] Promotional Text: Verify it uses the final public name where applicable
...
- [x] All app-name placeholders have been replaced with the final public name.
